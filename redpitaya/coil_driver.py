...
class CoilDriver:
    ...
    def sample(self, waveform, randomize_phase_only=False, random_single_tone=False, normalize_gain=False, test_mode=False) -> Tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray]:
        """
        ...
        normalized_spectrum[nonzero_mask] = voltage_spectrum[nonzero_mask] / velocity_transfer[nonzero_mask]
